 ...
 * - Saffron/Amber fill bg-[#EEEBDA] text-white with white checkmark for selected chips
    ...
    <div className="w-full h-full bg-[#F7F7F8] flex flex-col justify-between select-none relative overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-none pb-24">
        ...
        <div className="sticky top-0 z-30 bg-[#F7F7F8]/95 backdrop-blur-md">
          ...
          <div className="px-4 pb-3 flex items-center gap-3 border-b border-[#E5E7EB]">
            ...
            <h1 className="text-[20px] font-bold text-[#1E213D] leading-none">
        ...
        <div className="w-full pb-8 pt-1">
          ...
          <div className="w-full">
            <h2 className="text-[15px] font-bold text-[#1E213D] px-4 mt-4 mb-2.5">
              {cityName} शहर
            </h2>
                ...
                return (
                  <button
                    ...
                    className={`h-[40px] px-4 rounded-[14px] text-[13px] font-medium flex items-center justify-center gap-1.5 transition-all cursor-pointer active:scale-95 select-none ${
                      isSelected
                        ? 'bg-[#EEEBDA] text-white border border-[#EEEBDA] shadow-sm'
                        : 'bg-white text-[#1E213D] border border-[#D1D5DB] hover:border-[#1E213D]'
                    }`}
                  >
          ...
          <div className="w-full">
            <h2 className="text-[15px] font-bold text-[#1E213D] px-4 mb-2.5">
              {cityName} ग्रामीण
            </h2>
            <div className="flex flex-wrap gap-2.5 px-4">
              {ruralZones.map((zone) => {
      ...
      <div className="w-full p-4 bg-[#F7F7F8] shrink-0 z-30">
        <button
          type="button"
          onClick={handleSave}
          className="h-[56px] w-full rounded-[16px] bg-[#1E213D] text-white font-medium text-[20px] shadow-md active:scale-[0.99] hover:bg-[#22334D] transition-all flex items-center justify-center cursor-pointer"
        >
          सेव करें
        </button>
      </div>
