    ...
    <div className="w-full h-full bg-[#F7F7F4] flex flex-col justify-between pt-[64px] pb-6 px-6 select-none relative">
      ...
      <div className="w-full flex-1 flex flex-col justify-center items-center -mt-6">
        ...
        <p className="mt-2 text-[14px] text-center leading-[1.5] text-[#6B7280] whitespace-pre-line px-2">
          {"आपके नंबर "}
          <span className="text-[#F5B55C] font-semibold">{displayPhone}</span>
          {" पर "}
          <span className="text-[#F5B55C] font-semibold">6 अंकों</span>
          {" का\nOTP भेजा गया है"}
        </p>
        ...
        >
          {otp.map((digit, idx) => (
            <div 
              key={idx} 
              className="w-[48px] h-[64px] bg-white rounded-[12px] border border-[#B0B7C3] flex flex-col items-center justify-center relative focus-within:border-[#2B2437] focus-within:ring-2 focus-within:ring-[#2B2437]/20 transition-all shadow-2xs"
            >
              <input
                ...
                className="text-[22px] font-bold text-[#2B2437] text-center bg-transparent outline-none w-full h-full z-10 select-all"
              />
        ...
        <div className="mt-5 text-center text-[14px]">
          <span className="text-[#2B2437] font-normal">OTP नहीं मिला? </span>
          {timer > 0 ? (
            ...
            <button
              ...
              className="font-bold text-[#F5B55C] hover:underline cursor-pointer"
            >
              फिर से भेजें
            </button>
          )}
      ...
      <div className="w-full flex items-center justify-center gap-2 pb-2">
        <div className="w-5 h-5 rounded-full bg-[#2B2437] flex items-center justify-center text-white shadow-2xs">
