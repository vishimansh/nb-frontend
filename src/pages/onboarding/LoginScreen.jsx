    ...
    <div className="w-full h-full bg-[#F7F7F4] flex flex-col justify-center px-6 pt-[64px] pb-8 select-none">
      ...
      <div className="w-full flex flex-col my-auto">
        ...
        <div className="mt-8">
          ...
          <div className="h-[56px] bg-white rounded-[16px] border border-[#B0B7C3] flex items-center px-4 focus-within:border-[#2B2437] focus-within:ring-2 focus-within:ring-[#2B2437]/10 transition-all shadow-xs">
