  ...
  return (
    <div className="w-full h-full bg-[#F7F7F4] flex flex-col relative select-none overflow-hidden font-sans">
      ...
      <header className="px-4 py-3 bg-[#F7F7F4] flex items-center justify-between border-b border-[#E5E7EB]/80 shrink-0 sticky top-[54px] z-20">
        ...
        <h1 className="text-[18px] font-bold text-[#1E213D] tracking-tight text-center flex-1 pr-[46px] leading-normal">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-none pb-6">
        ...
        <div className="mx-4 mt-4 bg-white rounded-[24px] border border-[#E5E7EB] shadow-sm p-4">
          ...
          <div className="flex items-center gap-2 mb-3.5">
            <div className="w-7 h-7 rounded-[8px] bg-[#FFF9EE] border border-[#F7C873] flex items-center justify-center text-[#EEEBDA] shrink-0">
              <Monitor size={16} color="#EEEBDA" variant="Bold" />
            </div>
            <h2 className="text-[16px] font-bold text-[#1E213D] leading-snug">डिसप्ले सेटिंग्स</h2>
          </div>
          ...
          <div className="space-y-2.5">
            ...
            >
              <div className="flex items-center">
                {/* Dark Navy Icon Box */}
                <div className="w-10 h-10 rounded-xl bg-[#1E213D] text-white flex items-center justify-center font-bold text-[15px] mr-3 flex-shrink-0 shadow-2xs">
                  Aa
                </div>
                {/* Text Block */}
                <div className="flex flex-col">
                  <span className="text-[14px] font-bold text-[#1E213D] leading-snug">फ़ॉन्ट साइज़</span>
            ...
            >
              <div className="flex items-center">
                {/* Dark Navy Icon Box */}
                <div className="w-10 h-10 rounded-xl bg-[#1E213D] text-white flex items-center justify-center mr-3 flex-shrink-0 shadow-2xs">
                  <Sun1 size={18} color="#FFFFFF" variant="Bold" />
                </div>
                <span className="text-[14px] font-bold text-[#1E213D] leading-snug">ऐप मोड</span>
              </div>
                ...
                <div
                  className={`text-[11px] font-bold px-3 py-1 rounded-full relative flex items-center gap-1.5 transition-colors ${
                    selectedAppMode === 'system'
                      ? 'bg-[#1E213D] text-white shadow-xs'
                      : 'text-[#6B7280]'
                  }`}
                >
                  {selectedAppMode === 'system' && (
                    <span className="w-1.5 h-1.5 rounded-full bg-[#EEEBDA] shrink-0" />
                  )}
                ...
                <div
                  className={`text-[11px] font-medium px-2 py-1 leading-tight ${
                    selectedAppMode === 'light'
                      ? 'bg-[#1E213D] text-white rounded-full'
                      : 'text-[#6B7280]'
                  }`}
                >
                  लाइट
        ...
        <div className="mx-4 mt-4 bg-white rounded-[24px] border border-[#E5E7EB] shadow-sm p-4">
          ...
          <div className="flex items-center gap-2 mb-3.5">
            <div className="w-7 h-7 rounded-[8px] bg-[#FFF9EE] border border-[#F7C873] flex items-center justify-center text-[#EEEBDA] shrink-0">
              <ShieldSecurity size={16} color="#EEEBDA" variant="Bold" />
            </div>
            <h2 className="text-[16px] font-bold text-[#1E213D] leading-snug">गोपनीयता और नियम</h2>
          </div>
          ...
          <div className="space-y-2.5">
            ...
            <div className="h-[64px] bg-[#F9FAFB] rounded-[16px] border border-[#F1F3F5] px-3.5 flex items-center justify-between">
              <div className="flex items-center flex-1 mr-3">
                ...
                <div className="flex flex-col">
                  <span className="text-[14px] font-bold text-[#1E213D] leading-snug">व्यक्तिगत विज्ञापन</span>
              ...
              <button
                ...
                className={`w-12 h-7 rounded-full transition-colors duration-200 ease-in-out cursor-pointer p-0.5 flex items-center shrink-0 ${
                  personalizedAdsEnabled ? 'bg-[#EEEBDA] justify-end' : 'bg-[#D1D5DB] justify-start'
                }`}
              >
                <motion.div
                  layout
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-[14px] font-semibold text-[#1E213D] leading-none">हमारे बारे में</span>
              </div>
              <ArrowRight2 size={14} color="#9CA3AF" />
            </div>
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-[14px] font-semibold text-[#1E213D] leading-none">प्राइवेसी पॉलिसी</span>
              </div>
              <ArrowRight2 size={14} color="#9CA3AF" />
            </div>
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-[14px] font-semibold text-[#1E213D] leading-none">नियम एवं शर्तें</span>
              </div>
              <ArrowRight2 size={14} color="#9CA3AF" />
            </div>
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-[14px] font-semibold text-[#1E213D] leading-none">ऐप को रेट करें</span>
              </div>
              <ArrowRight2 size={14} color="#9CA3AF" />
            </div>
        ...
        {isDeleteModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            >
              ...
              {/* Title */}
              <h3 className="text-[17px] font-bold text-[#1E213D] leading-snug mb-2">
