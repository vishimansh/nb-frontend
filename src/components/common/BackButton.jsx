 ...
 * - 20px Iconsax ArrowLeft2 icon in navy (#2B2437)
...
export default function BackButton({
  ...
  return (
    <button
      ...
      className={`w-[46px] h-[46px] rounded-[14px] bg-white border border-[#D1D5DB] flex items-center justify-center shadow-2xs cursor-pointer active:scale-95 flex-shrink-0 transition-transform text-[#2B2437] ${className}`}
    >
