      ...
      <div className="absolute inset-0 z-50 overflow-hidden select-none pointer-events-auto">
        ...
        >
          ...
          <div className="px-5 pt-3 pb-3 border-b border-[#F1F3F5] flex items-center justify-between bg-white relative shrink-0">
            ...
            {/* Title */}
            <h2 className="text-[16px] font-bold text-[#2B2437] mt-2">
            ...
            <button
              ...
              onClick={handleClose}
              aria-label="बंद करें"
              className="mt-2 text-[#6B7280] hover:text-[#2B2437] cursor-pointer active:scale-90 transition-transform flex items-center justify-center"
            >
              ...
              activeComments.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-9 h-9 rounded-full bg-[#2B2437] text-white font-bold text-[13px] flex items-center justify-center flex-shrink-0 shadow-2xs">
                      {initial}
                    </div>
          ...
          >
            {/* User Avatar */}
            <div className="w-8 h-8 rounded-full bg-[#2B2437] text-white text-[11px] font-bold flex items-center justify-center flex-shrink-0">
              आप
            </div>
            ...
            <input
              ...
              className="flex-1 h-11 bg-[#F9FAFB] rounded-full border border-[#E5E7EB] px-4 text-[13px] text-[#2B2437] placeholder-[#9CA3AF] outline-none focus:border-[#2B2437] transition-colors"
            />
            ...
            <button
              ...
              className={`w-9 h-9 rounded-full flex items-center justify-center transition-all duration-150 flex-shrink-0 ${
                commentText.trim()
                  ? 'bg-[#F5B55C] text-[#2B2437] cursor-pointer active:scale-95 shadow-sm'
