    ...
    <div className={`rounded-[24px] bg-[#FAF5F2] border border-[#F0E2DA] p-6 shadow-xs select-none ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <h3 className="text-[24px] font-bold text-[#2B2437] leading-none tracking-tight">
            लाइव अपडेट्स
          </h3>
        </div>
            ...
            return (
              <div key={item.id || idx} className="relative flex items-start gap-3.5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Headline (16px bold) */}
                  <h4 className="text-[16px] font-bold text-[#2B2437] leading-[1.38] mt-2.5 tracking-tight">
                    {heading}
                  </h4>
