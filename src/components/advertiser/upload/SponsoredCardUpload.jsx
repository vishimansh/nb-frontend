...
import { DocumentUpload, Trash, Link2, Crown } from 'iconsax-react';
...
export default function SponsoredCardUpload({
  headline,
  setHeadline,
  description,
  setDescription,
    ...
    <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-[14px] font-bold text-[#2B2437] leading-none">
              प्रायोजित स्टोरी कार्ड
            </h3>
            <span className="text-[11px] text-[#B45309] font-medium leading-none">
              न्यूज़ फीड स्टोरी प्रारूप
            </span>
          </div>
        </div>
      </div>

      {/* Sponsored Image Upload */}
      <div className="bg-white rounded-[20px] border border-[#E5E7EB] p-4 shadow-2xs space-y-3">
        <span className="text-[14px] font-bold text-[#2B2437] block">
          स्टोरी फोटो अपलोड करें (16:9 या 3:2)
        </span>
        ...
        {uploadedMediaUrl ? (
          <div className="relative rounded-[16px] overflow-hidden border border-[#E5E7EB] bg-black aspect-[16/9] max-h-[220px] mx-auto flex items-center justify-center shadow-inner">
            ...
            <span className="absolute top-2.5 left-2.5 bg-[#E39026] text-white text-[10px] font-bold px-2 py-0.5 rounded-md shadow-xs">
      ...
      <div className="bg-white rounded-[20px] border border-[#E5E7EB] p-4 shadow-2xs space-y-3.5">
        <div>
          ...
          <input
            ...
            placeholder="जैसे: व्यापार में नई शुरुआत के लिए विशेष प्रस्तुति"
            maxLength={60}
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            maxLength={140}
            placeholder="अपनी कहानी या सर्विस के बारे में बताएं..."
