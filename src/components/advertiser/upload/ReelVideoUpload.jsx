...
import { VideoPlay, DocumentUpload, Trash, VolumeHigh, Link2 } from 'iconsax-react';
...
export default function ReelVideoUpload({
  headline,
  setHeadline,
  description,
  setDescription,
  ...
  const handleFileChange = (e) => {
    ...
    if (file.size > 25 * 1024 * 1024) {
      setAspectRatioError('कृपया 25MB से कम आकार का वीडियो अपलोड करें।');
      return;
    }
    ...
    reader.onload = (event) => {
      ...
      if (isVideo) {
        ...
        img.onload = () => {
          ...
          if (!isVertical) {
            setAspectRatioError('कृपया 9:16 वर्टिकल (खड़ा) वीडियो या इमेज अपलोड करें।');
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-[#FFF9EE] border border-[#FDE68A] rounded-[16px] p-3 flex items-center justify-between shadow-2xs">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-[10px] bg-[#E39026] text-white flex items-center justify-center">
            <VideoPlay size={18} color="#FFFFFF" variant="Bold" />
          </div>
          <div>
      ...
      <div className="bg-white rounded-[20px] border border-[#E5E7EB] p-4 shadow-2xs space-y-3">
        ...
        {uploadedMediaUrl ? (
          <div className="relative rounded-[16px] overflow-hidden border border-[#E5E7EB] bg-black aspect-[9/16] max-h-[280px] mx-auto flex items-center justify-center shadow-inner">
            {uploadedMediaUrl.startsWith('data:video') ? (
              <video
            ...
            <div className="absolute top-2.5 left-2.5 bg-black/60 backdrop-blur-xs text-white text-[10px] font-bold px-2 py-1 rounded-full flex items-center gap-1">
              <VolumeHigh size={13} color="#FFFFFF" />
              <span>साउंड ऑन</span>
            </div>
          ...
          >
            ...
            <span className="text-[14px] font-semibold text-[#2B2437] leading-tight">
              वीडियो अपलोड करने के लिए टैप करें
            </span>
            <span className="text-[12px] text-[#6B7280] font-normal mt-1">
              9:16 खड़ा वीडियो (अधिकतम 25MB)
            </span>
          </div>
        )}
      ...
      <div className="bg-white rounded-[20px] border border-[#E5E7EB] p-4 shadow-2xs space-y-3.5">
        <div>
          ...
          <input
            ...
            placeholder="जैसे: नए ऑफर पर भारी छूट!"
            maxLength={60}
