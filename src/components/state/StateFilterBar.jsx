 ...
 * - Active state chip: solid navy pill (bg-[#2B2437]), rounded-full, h-[34px], px-4, text-[13px] font-medium, with leading white MapPin icon; clicking it opens state selection
 * - Inactive state chip: transparent pill, border-[#9CA3AF], rounded-full, h-[34px], px-4, text-[13px] font-medium text-[#2B2437]
 ...
 * - Trailing "✎ अपने राज्य चुनें": transparent pill, border-[#9CA3AF], rounded-full, h-[34px], px-4, text-[13px] font-medium text-[#2B2437] with PencilSimple icon
 */
