...
export default function StateEmptyState({ onSelectStateClick }) {
  return (
    <div className="w-full h-full min-h-[460px] flex flex-col items-center justify-center px-6 select-none">
      ...
      {/* Headline */}
      <h2 className="text-[17px] font-bold text-[#1E213D] text-center">
      ...
      <button
        ...
        className="h-12 px-6 rounded-[16px] bg-[#1E213D] text-white font-bold text-[14px] shadow-md active:scale-95 hover:bg-[#22334D] transition-all cursor-pointer"
      >
        राज्य चुनें
      </button>
    </div>
