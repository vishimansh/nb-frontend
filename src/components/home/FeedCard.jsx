...
export const CATEGORY_PALETTES = {
  ...
  city: { label: 'शहर', color: '#EEEBDA', icon: Location },
  state: { label: 'राज्य', color: '#0284C7', icon: Buildings },
  country: { label: 'देश', color: '#1E213D', icon: DocumentText },
  'top-news': { label: 'टॉप न्यूज़', color: '#EEEBDA', icon: DocumentText },
  'top_news': { label: 'टॉप न्यूज़', color: '#EEEBDA', icon: DocumentText },
};
    ...
    >
      ...
      <div className="flex items-start justify-between w-full min-h-[69px] gap-2">
        ...
        <div className="flex-1 min-w-0 min-h-[69px] flex flex-col justify-start">
          ...
          <h3
            className="mt-[6px] pt-[1px] text-[14px] font-medium text-[#1E213D] leading-[17px] line-clamp-3 overflow-hidden text-ellipsis"
            style={{
              display: '-webkit-box',
              WebkitLineClamp: 3,
      ...
      {/* 0.64px Hairline Divider: #1E213D at 8% opacity (8px gap above and below) */}
      <div
      ...
      <div className="flex items-center justify-between w-full h-[18px] text-[10px] text-[#6B7280]">
        ...
        <div className="flex items-center gap-[32px] relative">
          ...
          <button
            ...
            className="w-[18px] h-[18px] rounded-full bg-[#1E213D] flex items-center justify-center text-white cursor-pointer active:opacity-80 shrink-0"
          >
          ...
          <button
            ...
            className="w-[18px] h-[18px] flex items-center justify-center text-[#1E213D] hover:text-black cursor-pointer shrink-0"
          >
            <More size={18} color="#1E213D" variant="Linear" />
          </button>
