      ...
      {filteredArticles.length > 0 ? (
        ...
        <div className="w-[386px] py-12 px-6 flex flex-col items-center justify-center text-center bg-white rounded-[16px] border border-[#E5E7EB] mt-4 shadow-xs">
          ...
          <button
            ...
            className="h-[42px] px-5 bg-[#1E213D] text-white text-[13px] font-semibold rounded-[12px] shadow-sm hover:bg-[#22334D] transition-all cursor-pointer active:scale-95"
          >
